...
view model =
    let
        ...
        angleSeconds =
            angleCalculator (Date.second theDateNow)

        angleMinutes =
            angleCalculator (Date.minute theDateNow)

        angleHours =
            angleCalculator (analogHour theDateNow)
...
tick minute =
    let
        ...
        xStart =
            toString (50 + tickStart * cos angle)

        yStart =
            toString (50 + tickStart * sin angle)
    in
